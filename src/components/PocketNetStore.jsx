...
export default function PocketNetStore() {
  ...
  // ✅ PRECIO SOLO PARA MOSTRAR EN FRONTEND - NO SE ENVÍA AL BACKEND
  const precio = 1; // Para pruebas - Cambia a 399 para que coincida con backend
    ...
    try {
      ...
      const response = await fetch('/api/stripe', {
        ...
        body: JSON.stringify({
          ...
          // ⚠️ NO enviamos "precio" - el backend tiene precio fijo
        })
      });
    ...
    <div className="min-h-screen bg-gradient-to-br from-pink-50 to-red-50">
      ...
      <main className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="bg-gradient-to-r from-pink-600 to-red-600 rounded-3xl p-8 mb-8 text-white relative overflow-hidden">
          ...
          <h1 className="text-5xl font-bold mb-4">${precio} MXN</h1>
